                ...
                <div class="row">
                    <div class="col">
                        <div class="card-body">
                            ...
                            <form action="enviar_contacto.php" name="add_form" method="post"
                                ...
                                <textarea class="form-control" name="comentario" id="comentario" rows="10"
                    ...
                    <div class="col mt-5">
                        ...
                        <div class="mt-5">
                            <iframe
                                src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d7933.649600524243!2d-75.435459!3d6.154214!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x55a99dfeb9f3a409!2sPortanova%20Center!5e0!3m2!1ses-419!2sus!4v1609012038820!5m2!1ses-419!2sus"
                                width="600" height="368" frameborder="0" style="border:0;" allowfullscreen=""
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-3 my-3 my-lg-0 text-lg-center text-center">
                    ...
                    <a class="redes btn btn-social mx-3" href="https://www.facebook.com/autosleosas/" target="_blank"><i
                            class="fab fa-facebook-f"></i></a>
                    <a class="redes btn btn-social mx-3" href="https://www.instagram.com/autosleo/" target="_blank"><i
